...
class SuperUserDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how super users are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(super_user)
  #   "SuperUser ##{super_user.id}"
  # end
end
